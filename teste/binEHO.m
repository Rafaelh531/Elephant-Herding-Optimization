%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Nome do Arquivo: binEHO.m
% Descrição: Breve Algoritmo de otimização de rebanho de elefantes binário.
%
...
while t < max_geracoes
    ...
    % Atualiza as posições dos elefantes em cada clã (OPERADOR DE ATUALIZAÇÃO)
    for i = 1:n_cla
        ...
        % Substitui as piores soluções do clã (OPERADOR DE SEPARAÇÃO)
